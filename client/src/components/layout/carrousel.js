...
const galleryContainer = document.getElementById('contain');
const galleryControlsContainer = document.getElementById('control');
...
class Carousel {
  ...
  setControls() {
    this.carouselControls.forEach(control => {
      var a = 'gallery-controls-'+control;
      galleryControlsContainer.appendChild(document.createElement('button')).className = a;
    }); 
